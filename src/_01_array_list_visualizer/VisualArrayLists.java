...
public class VisualArrayLists implements ActionListener {
	...
	public void addThingsToList() {
		...
		if(list.contains("the lourve")) {
			System.out.println("aaaur they've done it again, 'VIVA LA REVOLUTION' ");
		} else {
			System.out.println("the mona lisa has emergeddd.");
		}
